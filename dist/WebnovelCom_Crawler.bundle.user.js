...
module.exports = __webpack_require__(5302)

__webpack_require__(1200)
__webpack_require__(5630)
...
;(function (factory) {
  ...
  if (true) {
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(5302), __webpack_require__(2677)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
;(function (factory) {
  ...
  if (true) {
    // Register as an anonymous AMD module:
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(5302), __webpack_require__(5630)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__))
  } else {}
...
;(function (factory) {
  ...
  if (true) {
    // Register as an anonymous AMD module:
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(5302)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__))
  } else {}
...
;(function (factory) {
  ...
  if (true) {
    // Register as an anonymous AMD module:
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(5302), __webpack_require__(5166)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__))
  } else {}
...
;(function (factory) {
  ...
  if (true) {
    // Register as an anonymous AMD module:
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(5302), __webpack_require__(1200), __webpack_require__(5630)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__))
  } else {}
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(2121), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(1244), __webpack_require__.b);
...
const createWorker = __webpack_require__(1158);
...
const OEM = __webpack_require__(6308);
...
const getId = __webpack_require__(5504);
...
const createJob = __webpack_require__(1949);
const { log } = __webpack_require__(3486);
const getId = __webpack_require__(5504);
...
const resolvePaths = __webpack_require__(1937);
const circularize = __webpack_require__(3634);
const createJob = __webpack_require__(1949);
const { log } = __webpack_require__(3486);
const getId = __webpack_require__(5504);
const { defaultOEM } = __webpack_require__(9154);
const {
  defaultOptions,
  spawnWorker,
  terminateWorker,
...
const createScheduler = __webpack_require__(7877);
const createWorker = __webpack_require__(1158);
const Tesseract = __webpack_require__(181);
const languages = __webpack_require__(9520);
const OEM = __webpack_require__(6308);
const PSM = __webpack_require__(7895);
const { setLogging } = __webpack_require__(3486);
...
const isElectron = __webpack_require__(9134);
...
const isBrowser = __webpack_require__(6376)('type') === 'browser';
const resolveURL = isBrowser ? __webpack_require__(5072) : s => s; // eslint-disable-line
...
const { version, dependencies } = __webpack_require__(4547);
const defaultOptions = __webpack_require__(8720);
 ...
 * @author Jerome Wu <jeromewus@gmail.com>
 */
const defaultOptions = __webpack_require__(4040);
const spawnWorker = __webpack_require__(1005);
const terminateWorker = __webpack_require__(25);
const onMessage = __webpack_require__(9804);
const send = __webpack_require__(7247);
const loadImage = __webpack_require__(1196);
...
const resolveURL = __webpack_require__(5072);
const blueimpLoadImage = __webpack_require__(9303);
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./src/css/crawler.css
var crawler = __webpack_require__(9184);
;// CONCATENATED MODULE: ./src/css/crawler.css
...
var update = injectStylesIntoStyleTag_default()(crawler/* default */.Z, options);




       /* harmony default export */ const css_crawler = (crawler/* default */.Z && crawler/* default.locals */.Z.locals ? crawler/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/js/Crawler/variable/Variable.js
// DivMain
const DivMain = "divMain";
const DivMainId = "#" + DivMain;

const StatusChapter = { LOCKED: 'locked', UNLOCKED: 'unlocked', FREE: 'free', PRIVATE: 'private' };

// 
const LS_Login_R = "WebNovel_Login_R";

// Login
const SelectLogin = "sLogin";
...
;// CONCATENATED MODULE: ./src/js/Crawler/html/Login.js
...
;// CONCATENATED MODULE: ./src/js/Crawler/html/book/DivPanel.js
...
;// CONCATENATED MODULE: ./src/js/Crawler/class/ParserClass.js
...
class ParserClass_ParserChapter extends ParserBook {
    constructor(_site) {
        super(_site);
        this.endUrl = "";
    }
...
async function setReadLocal(_bookChapter, _bId, _index, _type) {
    let bookId = getReadLocal();
...
;// CONCATENATED MODULE: ./src/js/Crawler/html/book/CreateTableSites.js
...
function CreateTableSites(_sites, _bookChapters, _bId) {
    ...
    for (let i in _sites) {
        for (let j in _sites[i]) {
            ...
            // Read
            if (_sites[i][j] instanceof ParserClass_ParserChapter) {
...
;// CONCATENATED MODULE: ./src/js/Crawler/ReplaceText.js
...
async function GetChapterFetch(_url, _cId) {
    return await FetchXHR_fetchXHR(FetchXHR_FXmode.xhrHTML, _url)
        .then(data => {
...
async function CreateDivMain(_sitesParser, _sitesGetText, _bookChapters, _bookId, _chLast, _chIndexLastLocked, _statusChapter, _cId = "") {
    // divMain
    let divMain;
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/2fetch/apiSearch/artBook/mWuxiaworldCo.js
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/2fetch/apiSearch/artBook/novelupdatesCc.js
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/2fetch/apiSearch/artBook/readlightnovelCc.js
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/2fetch/apiSearch/artBook/readlightnovelCo.js
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/2fetch/apiSearchChapter/lightnovelreaderOrg.js





class lightnovelreaderOrg extends ParserClass_ParserChapter {
    constructor() {
    ...
    async totalChapters() {
        if (this.checkBookUndefined()) {
            ...
            let isError = '';
            await FetchXHR_fetchXHR(FetchXHR_FXmode.xhrJSON, this.apiSearch.href)
                .then(data => {
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/2fetch/apiSearchChapter/bookWings/ltnovelCom.js





class ltnovelCom extends ParserClass_ParserChapter {
    constructor() {
    ...
    async totalChapters() {
        if (this.checkBookUndefined()) {
            ...
            let isError = '';
            await FetchXHR_fetchXHR(FetchXHR_FXmode.xhrHTML, this.apiSearch.href, {
                "headers": {
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/2fetch/apiSearchChapter/bookWings/novelmtCom.js





class novelmtCom extends ParserClass_ParserChapter {
    constructor() {
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/2fetch/apiSearchChapter/bookWings/readwnCom.js





class readwnCom extends ParserClass_ParserChapter {
    constructor() {
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/2fetch/apiSearchChapter/bookWings/wuxiahereCom.js





class wuxiahereCom extends ParserClass_ParserChapter {
    constructor() {
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/2fetch/apiSearchChapter/bookWings/wuxiapubCom.js





class wuxiapubCom extends ParserClass_ParserChapter {
    constructor() {
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/2fetch/htmlSearch/mMylovenovelCom.js
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/2fetch/htmlSearchChapter/freewebnovelCom.js





class freewebnovelCom extends ParserClass_ParserChapter {
    constructor() {
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/2fetch/htmlSearchChapter/novelfullvipCom.js





class novelfullvipCom extends ParserClass_ParserChapter {
    constructor() {
...
;// CONCATENATED MODULE: ./src/js/Domain/domain.js
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/2fetch/htmlSearchChapter/novelscafeCom.js





class novelscafeCom extends ParserClass_ParserChapter {
    constructor() {
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/2fetch/htmlSearchChapter/POST/novelsonlineNet.js





class novelsonlineNet extends (/* unused pure expression or super */ null && (ParserChapter)) {
    constructor() {
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/2fetch/search/lightnovelplusCom.js
...
class lightnovelplusCom extends ParserSearch {
    ...
    async Open() {
        ...
        let isLucky = false;
        var isError = '';
        await FetchXHR_fetchXHR(FetchXHR_FXmode.xhrHTML, this.site.href)
            .then(data => {
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/apiSearch/lightnovelsMe.js
...
class octopiiCo extends ParserClass_ParserChapter {
    constructor() {
...
class webnovelonlineCom extends ParserClass_ParserChapter {
    constructor() {
...
class madnovelCom extends ParserClass_ParserChapter {
    constructor() {
...
class novelbuddyCom extends ParserClass_ParserChapter {
    constructor() {
...
class novelforestCom extends ParserClass_ParserChapter {
    constructor() {
...
class novelfullMe extends ParserClass_ParserChapter {
    constructor() {
...
class novelfullplusCom extends ParserClass_ParserChapter {
    constructor() {
...
class novelpokiCom extends ParserClass_ParserChapter {
    constructor() {
...
class noveltop1Com extends ParserClass_ParserChapter {
    constructor() {
...
class readnovelfullCom extends ParserClass_ParserChapter {
    constructor() {
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/htmlSearchChapter/truyenNovel/novel/topwebnovelCom.js
...
class allnovelfullCom extends ParserClass_ParserChapter {
    constructor() {
...
class allnovelOrg extends ParserClass_ParserChapter {
    constructor() {
...
class novelfullCom extends ParserClass_ParserChapter {
    constructor() {
...
class oneStkissnovelLove extends ParserClass_ParserChapter {
    constructor() {
...
class latestnovelNet extends ParserClass_ParserChapter {
    constructor() {
...
class lightnovelMobi extends ParserClass_ParserChapter {
    constructor() {
...
class novelteamNet extends ParserClass_ParserChapter {
    constructor() {
...
class noveltrenchCom extends ParserClass_ParserChapter {
    constructor() {
...
class readnovelsOrg extends ParserClass_ParserChapter {
    constructor() {
...
class webnovelonlineNet extends ParserClass_ParserChapter {
    constructor() {
...
class readlightnovelMe extends ParserClass_ParserChapter {
    constructor() {
...
class lightnovelpubCom extends ParserClass_ParserChapter {
    constructor() {
...
class lightnovelworldCom extends ParserClass_ParserChapter {
    constructor() {
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/search/novelgateNet.js
...
;// CONCATENATED MODULE: ./src/js/Crawler/parsers/search/ranobesNet.js
...
;// CONCATENATED MODULE: ./src/js/Crawler/class/GetTextClass.js
class GetText {
    constructor(_site) {
        this.site = new URL(_site);
        this.bTitle = "";
...
;// CONCATENATED MODULE: ./src/js/Crawler/getText/g_lightnovelplusCom.js
