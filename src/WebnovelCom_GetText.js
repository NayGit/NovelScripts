...
import { bookWebNovel, glavaWebNovel, downloadBookIfno } from './js/webNovel'
import tanimoto from './js/StringProcent/tanimoto'
...
(async function () {
    ...
    if (BookId === -1) {
        BookId = localStorage.getItem("ln_" + bWN);
    ...
    while (true) {
        if (checkLoc !== location.href) {
            ...
            await GO(glavaWebNovel(location));
        }
        await new Promise(r => setTimeout(r, 6000));
    }
})();

async function GO(_gWN) {
